...
@Service
public class WitAiV23Recognizer implements Recognizer {

    private static final Logger logger = LoggerFactory.getLogger(WitAiV23Recognizer.class);
    ...
    @Autowired
    public WitAiV23Recognizer(@Value("${ffmpeg.path}") String ffmpeg,
                              @Value("${WITAT_V23}") List<String> configs,
                              Environment env,
    ...
    public RecognizerType getType() {
        return RecognizerType.WITAT_V23;
    }
